...
tse |> 
    ...
    scale_fill_manual(
        "Condition Sampled", values = c("#ff006e", "#e07a5f", "#457b9d")) +
    theme_minimal() +
    theme(
...
`addStepwiseDivergence`. If we normalize this by the time interval, this gives
an approximate slope for the change.
